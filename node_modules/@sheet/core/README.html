...
<p>For XLS and XLSB, <code>bookSST</code> must also be specified to support Rich Text runs
(this is a technical file format limitation, it does not affect XLSX):</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>out.xls<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>, bookSST<span class="pl-k">:</span> <span class="pl-c1">true</span>});
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>out.xlsb<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>, bookSST<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<h3>
...
<p>The following table shows the supported border styles in Excel (first column) as
...
matched but all Excel border styles will be written to HTML.</p>
<table>
<thead>
<tr>
<th align="left">Excel border value</th>
<th align="left">generated <code>border-style</code>
</th>
<th>matching <code>border-style</code>
</th>
</tr>
</thead>
<tbody>
...
<td align="left"><code>solid 1px</code></td>
<td>
<code>solid</code>  (width    1px)</td>
</tr>
<tr>
...
<td align="left"><code>solid 2px</code></td>
<td>
<code>solid</code>  (width    2px)</td>
</tr>
<tr>
<td align="left"><code>thick</code></td>
<td align="left"><code>solid 3px</code></td>
<td>
<code>solid</code>  (width &gt;= 3px)</td>
</tr>
<tr>
<td align="left"><code>double</code></td>
<td align="left"><code>double 3px</code></td>
<td>
<code>double</code> (width &gt;= 1px)</td>
</tr>
<tr>
<td align="left"><code>dotted</code></td>
<td align="left"><code>dotted 1px</code></td>
<td>
<code>dotted</code> (width    1px)</td>
</tr>
<tr>
...
<td align="left"><code>dotted 2px</code></td>
<td>
<code>dotted</code> (width &gt;= 2px)</td>
</tr>
<tr>
<td align="left"><code>dashed</code></td>
<td align="left"><code>dashed 1px</code></td>
<td>
<code>dashed</code> (width    1px)</td>
</tr>
<tr>
...
<td align="left"><code>dashed 2px</code></td>
<td>
<code>dashed</code> (width &gt;= 2px)</td>
</tr>
<tr>
...
<p>The <code>thin</code> border style will be used for all other HTML border styles (groove,
ridge, inset, outset) as they have no Excel equivalent.</p>
<p>For example:</p>
...
<h2>
<a id="user-content-cell-comments" class="anchor" href="#cell-comments" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell Comments</h2>
<p>Cell comments are storeed in the <code>c</code> array of cell objects.</p>
<p>Each comment object supports the following properties:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">Author of the comment</td>
</tr>
<tr>
...
<td align="left">Rich text array</td>
</tr>
</tbody>
</table>
<p>Additional named properties can be attached directly to the array:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<tr>
<td align="left"><code>hidden</code></td>
<td align="left">Hide comment (displays when mouse hovers over cell</td>
</tr>
<tr>
<td align="left"><code>!pos</code></td>
<td align="left">Position of comment</td>
</tr>
<tr>
<td align="left"><code>s</code></td>
<td align="left">Style (see below for limitations)</td>
</tr>
</tbody>
</table>
<details>
  <summary><b>How to specify comment position</b> (click to show)</summary>
<p>Note: for users of the Pro Image build or any build that includes image or chart
support, this is the same content displaye in "Image Dimensions and Location".</p>
<p>Comments can start anywhere in the worksheet.  There are three position styles:</p>
<p><strong>Absolute Position with Size</strong></p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">X-coordinate of upper-left corner (pixels)</td>
</tr>
<tr>
<td align="left"><code>y</code></td>
<td align="left">Y-coordinate of upper-left corner (pixels)</td>
</tr>
<tr>
<td align="left"><code>w</code></td>
<td align="left">width (pixels)</td>
</tr>
<tr>
<td align="left"><code>h</code></td>
<td align="left">height (pixels)</td>
</tr>
</tbody>
</table>
<p>The following example specifies an absolute size of 456 x 123 pixels starting
from the pixel position (0, 0):</p>
<div class="highlight highlight-source-js"><pre>{
  <span class="pl-c"><span class="pl-c">/*</span> location of upper-left corner (in pixels) <span class="pl-c">*/</span></span>
  x<span class="pl-k">:</span> <span class="pl-c1">0</span>, y<span class="pl-k">:</span> <span class="pl-c1">0</span>,
  <span class="pl-c"><span class="pl-c">/*</span> object size (in pixels) -- Excel will scale to fit dimensions <span class="pl-c">*/</span></span>
  w<span class="pl-k">:</span> <span class="pl-c1">456</span>, h<span class="pl-k">:</span> <span class="pl-c1">123</span>,
};</pre></div>
<p><strong>Relative Position with Size</strong></p>
<p>This style lets you anchor to a given starting cell.</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<tr>
<td align="left"><code>r</code></td>
<td align="left">row of upper-left corner (0-indexed)</td>
</tr>
<tr>
<td align="left"><code>c</code></td>
<td align="left">col of upper-left corner (0-indexed)</td>
</tr>
<tr>
<td align="left"><code>x</code></td>
<td align="left">X distance from upper-left corner of base cell (pixels)</td>
</tr>
<tr>
<td align="left"><code>y</code></td>
<td align="left">Y distance from upper-left corner of base cell (pixels)</td>
</tr>
<tr>
<td align="left"><code>w</code></td>
<td align="left">width (pixels)</td>
...
<p>The most common use case is to set a comment to show up to the right of a given
cell.  To do that, set <code>r</code> to the cell row, <code>c</code> to cell column + 1. For example:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> addr <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">encode_cell</span>({r<span class="pl-k">:</span><span class="pl-c1">3</span>, c<span class="pl-k">:</span><span class="pl-c1">4</span>});
ws[addr].<span class="pl-smi">c</span>[<span class="pl-s"><span class="pl-pds">"</span>!pos<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {
  r<span class="pl-k">:</span> <span class="pl-c1">3</span>, <span class="pl-c"><span class="pl-c">//</span> same row as cell</span>
  c<span class="pl-k">:</span> <span class="pl-c1">4</span><span class="pl-k">+</span><span class="pl-c1">1</span>, <span class="pl-c"><span class="pl-c">//</span> next column</span>
  x<span class="pl-k">:</span> <span class="pl-c1">0</span>, y<span class="pl-k">:</span><span class="pl-c1">0</span>, <span class="pl-c"><span class="pl-c">//</span> start at the topleft corner</span>
  w<span class="pl-k">:</span> <span class="pl-c1">456</span>, h<span class="pl-k">:</span> <span class="pl-c1">123</span>
}</pre></div>
<p><strong>Relative Position of Corners</strong></p>
<p>This lets you create comments that appear to span across a cell or range.</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<tr>
<td align="left"><code>R</code></td>
<td align="left">row of lower-right corner (0-indexed)</td>
</tr>
<tr>
<td align="left"><code>C</code></td>
<td align="left">col of lower-right corner (0-indexed)</td>
</tr>
<tr>
<td align="left"><code>X</code></td>
<td align="left">X distance from lower-right corner of base cell (pixels)</td>
</tr>
<tr>
<td align="left"><code>Y</code></td>
<td align="left">Y distance from lower-right corner of base cell (pixels)</td>
</tr>
</tbody>
</table>
<p>The following example specifies an comment covering over the cell B5.</p>
<ul>
<li>The address of the upper-left corner is <code>r = 4, c = 1</code>
</li>
<li>The upper-left pixel offset will be 0 in both directions.</li>
<li>The address of the lower-right corner is <code>R = r + 1 = 5, C = c + 1 = 2</code>
</li>
<li>The upper-left pixel offset will be 0 in both directions.</li>
</ul>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> addr <span class="pl-k">=</span> { r<span class="pl-k">:</span> <span class="pl-c1">4</span>, c<span class="pl-k">:</span> <span class="pl-c1">1</span> };
<span class="pl-k">var</span> rowspan <span class="pl-k">=</span> <span class="pl-c1">1</span>, colspan <span class="pl-k">=</span> <span class="pl-c1">1</span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>C3<span class="pl-pds">"</span></span>].<span class="pl-smi">c</span>[<span class="pl-s"><span class="pl-pds">"</span>!pos<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {
  <span class="pl-c"><span class="pl-c">/*</span> upper-left corner cell address<span class="pl-c">*/</span></span>
  c<span class="pl-k">:</span> <span class="pl-smi">addr</span>.<span class="pl-smi">c</span>, r<span class="pl-k">:</span> <span class="pl-smi">addr</span>.<span class="pl-smi">r</span>,
  <span class="pl-c"><span class="pl-c">/*</span> lower-right corner cell address<span class="pl-c">*/</span></span>
  <span class="pl-c1">C</span><span class="pl-k">:</span> <span class="pl-smi">addr</span>.<span class="pl-smi">c</span> <span class="pl-k">+</span> colspan, <span class="pl-c1">R</span><span class="pl-k">:</span> <span class="pl-smi">addr</span>.<span class="pl-smi">r</span> <span class="pl-k">+</span> rowspan,
  <span class="pl-c"><span class="pl-c">/*</span> zero pixel offset for both points <span class="pl-c">*/</span></span>
  x<span class="pl-k">:</span> <span class="pl-c1">0</span>, y<span class="pl-k">:</span> <span class="pl-c1">0</span>, <span class="pl-c1">X</span><span class="pl-k">:</span> <span class="pl-c1">0</span>, <span class="pl-c1">Y</span><span class="pl-k">:</span> <span class="pl-c1">0</span>
};</pre></div>
</details>
<p>The <code>s</code> key supports the following styles:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">Primary fill color</td>
</tr>
</tbody>
</table>
<p>The following example:</p>
<ul>
<li>adds a cell "C3" to the worksheet with value "abc"</li>
<li>adds a comment with a single author "SheetJS" and rich text</li>
<li>sets comment positioning to start at cell D5 and span 100 px width / height</li>
<li>makes comment fill in yellow</li>
</ul>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> comment_part <span class="pl-k">=</span> {
  a<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">"</span>SheetJS<span class="pl-pds">"</span></span>,
  <span class="pl-c1">R</span><span class="pl-k">:</span> [
    {t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>s<span class="pl-pds">"</span></span>, v<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>plain text <span class="pl-pds">"</span></span>},
    {t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>s<span class="pl-pds">"</span></span>, v<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>bold text <span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { bold<span class="pl-k">:</span> <span class="pl-c1">true</span> } }
  ]
};
<span class="pl-k">var</span> comment <span class="pl-k">=</span> [];
<span class="pl-smi">comment</span>.<span class="pl-c1">push</span>(comment_part);
comment[<span class="pl-s"><span class="pl-pds">"</span>!pos<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {c<span class="pl-k">:</span> <span class="pl-c1">3</span> <span class="pl-c"><span class="pl-c">/*</span> "D" <span class="pl-c">*/</span></span>, r<span class="pl-k">:</span> <span class="pl-c1">4</span> <span class="pl-c"><span class="pl-c">/*</span> "5" <span class="pl-c">*/</span></span>, w<span class="pl-k">:</span> <span class="pl-c1">100</span>, h<span class="pl-k">:</span> <span class="pl-c1">100</span>};
<span class="pl-smi">comment</span>.<span class="pl-smi">s</span> <span class="pl-k">=</span> { fgColor<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>FFFF00<span class="pl-pds">"</span></span> } };

<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_add_aoa</span>(ws, [[<span class="pl-s"><span class="pl-pds">"</span>abc<span class="pl-pds">"</span></span>]], {origin<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>C3<span class="pl-pds">"</span></span>});
ws[<span class="pl-s"><span class="pl-pds">"</span>C3<span class="pl-pds">"</span></span>].<span class="pl-smi">c</span> <span class="pl-k">=</span> comment;</pre></div>
<h2>
...
<code>width</code> and <code>height</code> properties indicating the number of pages to fit:</p>
...
<p>Other common settings are shown in the table below:</p>
<table>
<thead>
<tr>
<th align="left">Fit setting</th>
<th align="left">
<code>fit</code> object value</th>
</tr>
</thead>
<tbody>
<tr>
<td align="left">"Fit Sheet on One page"</td>
<td align="left"><code>{ width: 1, height: 1 }</code></td>
</tr>
<tr>
<td align="left">"Fit All Columns on One Page"</td>
<td align="left"><code>{ width: 1, height: 0 }</code></td>
</tr>
<tr>
<td align="left">"Fit All Rows on One Page"</td>
<td align="left"><code>{ width: 0, height: 1 }</code></td>
</tr>
</tbody>
</table>
...
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">centerY</span> <span class="pl-k">=</span> <span class="pl-c1">false</span>; <span class="pl-c"><span class="pl-c">//</span> align to top of content region</span></pre></div>
<h4>
